...
namespace webraak\component\app;

use Closure;
use webraak\component\Dir;
use webraak\component\File;
use webraak\component\HelperObject;
...
class AppProvider extends AppSource
{
     ...
     *
     * @param string|null $packageName for example "com_webraak_manager"
     * @return AppProvider
     */
    ...
    public static function save()
    {
        ...
        $data_for_save = '<?' . 'php' . "\n";
        $data_for_save .= '//webraak app file, generated at "' . gmdate('Y-m-d H:i') . "\"\n\n";
     ...
     * Call features app
     *
     * Example) AppProvider::com_webraak_manager('MainController')
     *
     * @param string $app
     * @param $arguments
     ...
     *
     * @param string $app example 'com_webraak_manager'
     * @param string $path
     * @param string $class
     * @param string $type
     * @return mixed|null
    ...
    private static function callClass($app, $path, $class, $type)
    {
        ...
        $className = 'webraak\\app\\' . $app . '\\' . $type . '\\' . $path . $class;
