...
class Dir
{
    ...
    public static function path($path = null, $app = null)
    {
        ...
        if (!is_null($path)) {
            if (!$isBase) {
                ...
                $path = HelperString::firstDelete($path, WEBRAAK_PATH);
    ...
    {
        return WEBRAAK_PATH . Router::app_folder . DIRECTORY_SEPARATOR . Router::getApp() . DIRECTORY_SEPARATOR;
    }
     ...
     */
    public static function thumb($img, $thumbSize = 128, $defaultImage = null, $path = WEBRAAK_PATH_THUMB, $isCreateThumb = false, $isCheck = true)
    {
