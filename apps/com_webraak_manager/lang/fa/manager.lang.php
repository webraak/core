...
return [
    'direction' => 'rtl',
    'webraak' => 'وبراک',
    'webraak_description' => 'پلتفرم اوپن سورس توسعه وب',
    'updating' => 'در حال بروزرسانی',
    'update' => 'بروزرسانی',
    'checking' => 'در حال بررسی',
    'updated' => 'بروزرسانی شد',
    'webraak_successfully_update_to' => 'وبراک با موفقیت به نسخه',
    'update_failed' => 'در هنگام بروزرسانی مشکلی بوجود آمده است',
    'your_webraak_is_up_to_date' => 'در حال حاضر شما از آخرین نسخه وبراک استفاده می کنید',
    'are_sure_update_pincore' => 'آیا میخواهید هسته وبراک را بروزرسانی کنید؟',
    'new_version' => 'نسخه جدید',
    'available' => 'موجود است',
    'about_webraak' => 'درباره وبراک',
    'return' => 'بازگشت',
    'add' => 'افزودن',
    'edit' => 'ویرایش',
    'delete' => 'حذف',
    ...
    'create_webraak_account' => 'ایجاد حساب کاربری وبراک',
    'required_login_for_download_app' => 'برای دانلود و نصب اپلیکیشن های مارکت به حساب کاربری وبراک خود متصل شوید',
    ...
    'manual_installation' => 'نصب اپلیکیشن',
    ...
    'upload_webraak_package_for_installing' => ' اپلیکیشن را با پسوند pin.* جهت نصب بارگذاری کنید',
