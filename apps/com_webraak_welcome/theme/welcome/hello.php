...
<head>
    ...
    <title><?php lang('welcome.welcome_to_webraak'); ?></title>
...
<div class="container">
    ...
    <div class="logo">
        <img src="<?php echo $_url ?>assets/images/webraak.png" alt="logo">
        <h1><?php lang('welcome.welcome_to_webraak'); ?></h1>
    </div>

    <div class="nav">
        <a target="_blank" href="https://www.webraak.com">
            <img alt="web" src="<?php echo $_url; ?>assets/images/web.svg"/> <?php lang('welcome.website'); ?>
        </a>
        <a target="_blank" href="https://www.webraak.com/blog">
            <img alt="blog" src="<?php echo $_url; ?>assets/images/blog.svg"/> <?php lang('welcome.blog'); ?></a>
        <a target="_blank" href="https://www.webraak.com/answers">
            <img alt="question" src="<?php echo $_url; ?>assets/images/question.svg"/> <?php lang('welcome.answers'); ?></a>
        <a target="_blank" href="https://www.github.com/webraak">
